read_rosbag MATLAB Python Package
...
2. Installing the read_rosbag Package

A. Change to the directory that contains the file setup.py and the subdirectory 
read_rosbag. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the read_rosbag Package

The read_rosbag package is on your Python path. To import it into a Python script or 
session, execute:
