matlab_evaluation MATLAB Python Package
...
2. Installing the matlab_evaluation Package

A. Change to the directory that contains the file setup.py and the subdirectory 
matlab_evaluation. If you do not have write permissions, copy all its contents to a 
...
3. Using the matlab_evaluation Package

The matlab_evaluation package is on your Python path. To import it into a Python script 
or session, execute:
