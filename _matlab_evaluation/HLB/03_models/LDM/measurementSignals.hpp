...
*/
for (int i{0}; i<300; i++){
    std::string name1 = "evalPointsSegment1_";
    std::string name2 = "evalPointsSegment2_";
    std::string name3 = "evalPointsSegment3_";
    
    std::string index = std::to_string(i);
    std::string name1_index = name1 + index;
    std::string name2_index = name2 + index;
    std::string name3_index = name3 + index;
    
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        name1_index,
        "-",
        &m_obj->evalPoints.evalPointsSegment1[i].value(),
        id++));
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        name2_index,
        "-",
        &m_obj->evalPoints.evalPointsSegment2[i].value(),
        id++));
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        name3_index,
        "-",
        &m_obj->evalPoints.evalPointsSegment3[i].value(),
        id++));
}
...
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        ...
        "evalPointsLengths_1",
        "-",
        reinterpret_cast<vfc::float32_t*>(&m_obj->evalPoints.evalPointsLengths[0]),
        id++));
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "evalPointsLengths_2",
        "-",
        reinterpret_cast<vfc::float32_t*>(&m_obj->evalPoints.evalPointsLengths[1]),
        id++));
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "evalPointsLengths_3",
        "-",
        reinterpret_cast<vfc::float32_t*>(&m_obj->evalPoints.evalPointsLengths[2]),
        id++));

for (int i{0}; i<4; i++){
    std::string name1 = "nodePointsCoordinates_X_";
    std::string name2 = "nodePointsCoordinates_Y_";
    std::string name3 = "nodePointsTheta_";
    ...
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        ...
        name1_index,
        "-",
        &m_obj->nodePoints.nodePointsCoordinates[i].PointsX.value(),
        id++));
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        name2_index,
        "-",
        &m_obj->nodePoints.nodePointsCoordinates[i].PointsY.value(),
        id++));
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        name3_index,
        "-",
        &m_obj->nodePoints.nodePointsTheta[i].value(),
        id++));
}
for (int i{0}; i<3; i++){
    std::string name = "indices_";
    std::string index = std::to_string(i);
    std::string name_index = name + index;
    ...
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        ...
        name_index,
        "-",
        reinterpret_cast<vfc::float32_t*>(&m_obj->driverModel.indices[i]),
        id++));
}
