...
// for (int i{0}; i<300; i++){
//     std::string name = "corridorEgoInputX";
//     std::string index = std::to_string(i);
//     std::string name_index = name + index;
//     
//     m_generateMeasurementFile->m_measurementValuesFloat.push_back(
...
// 
// for (int i{0}; i<300; i++){
//     std::string name = "corridorEgoInputY";
//     std::string index = std::to_string(i);
//     std::string name_index = name + index;
//     
//     m_generateMeasurementFile->m_measurementValuesFloat.push_back(
...
// 
// for (int i{0}; i<300; i++){
//     std::string name = "corridorGlobalY";
//     std::string index = std::to_string(i);
//     std::string name_index = name + index;
//     
//     m_generateMeasurementFile->m_measurementValuesFloat.push_back(
...
// for (int i{0}; i<3; i++){
//     std::string name = "corridorGlobalFrame.corridorOrientation";
//     std::string index = std::to_string(i);
//     std::string name_index = name + index;
//     
//     m_generateMeasurementFile->m_measurementValuesFloat.push_back(
...
for (int i{0}; i<3; i++){
    std::string name = "segmentParams.initPose.PointsX";
    std::string index = std::to_string(i);
    std::string name_index = name + index;
    ...
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        ...
        name_index,
        "-",
        &m_obj->segmentParams.initPose[i].PointsX.value(),
        id++));
}

for (int i{0}; i<3; i++){
    std::string name = "segmentParams.initPose.PointsY";
    std::string index = std::to_string(i);
    std::string name_index = name + index;
    ...
    m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        ...
        name_index,
        "-",
        &m_obj->segmentParams.initPose[i].PointsY.value(),
        id++));
}
...
//         "-",
//         &m_obj->trajectoryCoeffs.length.value(),
//         id++));

// m_generateMeasurementFile->m_measurementValuesFloat.push_back(
//         Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
//         "plannerFramePoseGlobalFrame.Pose2DCoordinates.PointsX",
//         "-",
//         &m_obj->plannerFramePoseGlobalFrame.Pose2DCoordinates.PointsX.value(),
//         id++));
// 
// m_generateMeasurementFile->m_measurementValuesFloat.push_back(
//         Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
//         "plannerFramePoseGlobalFrame.Pose2DCoordinates.PointsY",
//         "-",
//         &m_obj->plannerFramePoseGlobalFrame.Pose2DCoordinates.PointsY.value(),
//         id++));
// 
// m_generateMeasurementFile->m_measurementValuesFloat.push_back(
//         Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
//         "plannerFramePoseGlobalFrame.Pose2DTheta",
//         "-",
//         &m_obj->plannerFramePoseGlobalFrame.Pose2DTheta.value(),
//         id++));
...
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "egoPoseGlobalPlan.Pose2DCoordinates.PointsX",
        "-",
        &m_obj->egoPoseGlobalPlan.Pose2DCoordinates.PointsX.value(),
        id++));

m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "egoPoseGlobalPlan.Pose2DTheta",
        "-",
        &m_obj->egoPoseGlobalPlan.Pose2DTheta.value(),
        id++));

m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "egoPoseGlobalPlan.Pose2DCoordinates.PointsY",
        "-",
        &m_obj->egoPoseGlobalPlan.Pose2DCoordinates.PointsY.value(),
        id++));

m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[0].PointsX",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsX.value(),
        id++));

m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[0].PointsY",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsY.value(),
        id++));

m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[1].PointsX",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsX.value(),
        id++));
...
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[1].PointsY",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsY.value(),
        id++));
...
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[2].PointsX",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsX.value(),
        id++));
...
m_generateMeasurementFile->m_measurementValuesFloat.push_back(
        Dc::Emg::DevTest::MeasurementValue<vfc::float32_t>(
        "nodePointsEgoFrame.nodePointsCoordinates[2].PointsY",
        "-",
        &m_obj->nodePointsEgoFrame.nodePointsCoordinates[0].PointsY.value(),
        id++));
/*
...
std::string enumspecBit = "{0=\"false\", 1=\"true\"}";
/*m_generateMeasurementFile->m_measurementValuesBool.push_back(
Dc::Emg::DevTest::MeasurementValue<bool>(
		"LinearDriverModel.triggerPlanner",
		"",
		reinterpret_cast<bool*>(&m_obj->triggerPlanner),
		id++,
		enumspecBit));*/

m_generateMeasurementFile->m_measurementValuesBool.push_back(
Dc::Emg::DevTest::MeasurementValue<bool>(
		"LinearDriverModel.controlLogic.validity",
		"",
		reinterpret_cast<bool*>(&m_obj->controlLogic.validity),
		id++,
		enumspecBit));
