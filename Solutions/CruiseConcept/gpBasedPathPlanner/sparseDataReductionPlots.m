...
matFiles = dir(fullfile("C:\git\KDP\publications\GP\results\sparseGP\KPI_indSize*.mat"));
...
for i=1:length(matFiles)
    ...
    for shiftID = 1:numel(data.KPI)
        if(USE_NRMS)
            ...
            etaFiles = dir(fullfile("C:\git\KDP\publications\GP\results\sparseGP\ETA_indSize*.mat"));
