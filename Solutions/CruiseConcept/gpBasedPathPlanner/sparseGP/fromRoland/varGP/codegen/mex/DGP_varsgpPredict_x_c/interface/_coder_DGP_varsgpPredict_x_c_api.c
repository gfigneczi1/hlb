 ...
 *
 * _coder_DGP_varsgpPredict_x_c_api.c
 *
 * Code generation for function '_coder_DGP_varsgpPredict_x_c_api'
 *
 */

/* Include files */
#include "_coder_DGP_varsgpPredict_x_c_api.h"
#include "DGP_varsgpPredict_x_c.h"
...
void DGP_varsgpPredict_x_c_api(DGP_varsgpPredict_x_cStackData *SD,
                               ...
                               const mxArray *plhs[2])
{
  ...
  DGP_varsgpPredict_x_c(&st, &SD->f0.model, &SD->f0.Smodel, *m_in, *S_in,
                        &mu_MM, &var_MM);
...
/* End of code generation (_coder_DGP_varsgpPredict_x_c_api.c) */
