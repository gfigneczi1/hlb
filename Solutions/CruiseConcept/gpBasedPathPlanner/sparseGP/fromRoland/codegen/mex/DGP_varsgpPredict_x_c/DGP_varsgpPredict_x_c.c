...
static emlrtRSInfo emlrtRSI = {
    ...
    "arGP-new/varGP/DGP_varsgpPredict_x_c.m" /* pathName */
};
                           ...
                           const real_T S_in[49], real_T *mu_MM, real_T *var_MM)
{
  ...
  *var_MM = ((var_long + var_short) + 2.0 * c_y) - *mu_MM * *mu_MM;
  ...
  /*  in case for some numerical instabilities */
}

/* End of code generation (DGP_varsgpPredict_x_c.c) */
