 ...
 *
 * _coder_varsgpPredict_MM_y_c_api.c
 *
 * Code generation for function '_coder_varsgpPredict_MM_y_c_api'
 *
 */
...
void varsgpPredict_MM_y_c_api(varsgpPredict_MM_y_cStackData *SD,
                              ...
                              const mxArray *plhs[2])
{
  ...
  varsgpPredict_MM_y_c(&st, &SD->f0.model, *m_in, *S_in, &mu_MM, &var_MM);
...
/* End of code generation (_coder_varsgpPredict_MM_y_c_api.c) */
