...
static emlrtRSInfo emlrtRSI = {
    ...
    "arGP-new/varGP/varsgpPredict_MM_x_c.m" /* pathName */
};
...
void varsgpPredict_MM_x_c(const emlrtStack *sp, const struct0_T *model,
...
/* End of code generation (varsgpPredict_MM_x_c.c) */
