...
static emlrtRSInfo emlrtRSI = {
    ...
    "arGP-new/varGP/DGP_varsgpPredict_z_c.m" /* pathName */
};
...
void DGP_varsgpPredict_z_c(const emlrtStack *sp, const struct0_T *model,
...
/* End of code generation (DGP_varsgpPredict_z_c.c) */
