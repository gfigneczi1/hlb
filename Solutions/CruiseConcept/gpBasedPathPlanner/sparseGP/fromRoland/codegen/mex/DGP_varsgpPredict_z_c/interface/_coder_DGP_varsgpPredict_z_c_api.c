 ...
 *
 * _coder_DGP_varsgpPredict_z_c_api.c
 *
 * Code generation for function '_coder_DGP_varsgpPredict_z_c_api'
 *
 */

/* Include files */
#include "_coder_DGP_varsgpPredict_z_c_api.h"
#include "DGP_varsgpPredict_z_c.h"
#include "DGP_varsgpPredict_z_c_data.h"
#include "DGP_varsgpPredict_z_c_types.h"
...
static void t_emlrt_marshallIn(const emlrtStack *sp, const mxArray *Smodel,
...
static real_T (*v_emlrt_marshallIn(const emlrtStack *sp, const mxArray *m_in,
...
static real_T (*x_emlrt_marshallIn(const emlrtStack *sp, const mxArray *S_in,
                               ...
                               const char_T *identifier, struct3_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  u_emlrt_marshallIn(sp, emlrtAlias(Smodel), &thisId, y);
  emlrtDestroyArray(&Smodel);
}
                               ...
                               const emlrtMsgIdentifier *parentId, struct3_T *y)
{
  ...
  static const char_T *fieldNames[24] = {
      "type",   "objectFunc", "Likelihood", "GP",      "n",        "D",
      "y",      "X",          "m",          "indType", "indRepar", "Xu",
      "Xuinit", "nIndParams", "yy",         "vary",    "jitter",   "postm",
      "postS",  "Kmm",        "Kmn",        "Knm",     "L",        "invKm"};
  emlrtMsgIdentifier thisId;
  thisId.fParent = parentId;
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b((emlrtCTX)sp, parentId, u, 24,
                         (const char_T **)&fieldNames[0], 0U, (void *)&dims);
  thisId.fIdentifier = "type";
  c_emlrt_marshallIn(sp,
                     emlrtAlias(emlrtGetFieldR2017b((emlrtCTX)sp, u, 0, 0,
                                   ...
                                   const char_T *identifier))[7]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = w_emlrt_marshallIn(sp, emlrtAlias(m_in), &thisId);
                                   ...
                                   const char_T *identifier))[49]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = y_emlrt_marshallIn(sp, emlrtAlias(S_in), &thisId);
...
void DGP_varsgpPredict_z_c_api(DGP_varsgpPredict_z_cStackData *SD,
                               ...
                               const mxArray *plhs[2])
{
  ...
  t_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "Smodel", &SD->f0.Smodel);
  m_in = v_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "m_in");
  S_in = x_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "S_in");
  /* Invoke the target function */
  DGP_varsgpPredict_z_c(&st, &SD->f0.model, &SD->f0.Smodel, *m_in, *S_in,
                        &mu_MM, &var_MM);
...
/* End of code generation (_coder_DGP_varsgpPredict_z_c_api.c) */
