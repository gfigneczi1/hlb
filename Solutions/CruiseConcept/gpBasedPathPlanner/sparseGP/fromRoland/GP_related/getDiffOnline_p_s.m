function training_out_p = getDiffOnline_p_s(x,u,mu_lp,state_dot_hist,para,LTI)
...
diff_x = observations(:,1) - nominal(:,1)-mu_lp(1);
diff_y = observations(:,2) - nominal(:,2)-mu_lp(2);
diff_z = observations(:,3) - nominal(:,3)-mu_lp(3);
