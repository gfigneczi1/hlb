...
err_hist = [];
     ...
     for i = 1: para.N-para.trans.H
        ...
        %-----------------------------------------------------------%
          ...
          [u_opt_trans,cost_trans(i)]  = mpcCtrl_trans_DGP(xtrans(:,i),xrot(:,i),time(i),para,i); % considering the variance in prediction model
...
save('DGP_3rd.mat','x','u','cost_trans','mu_p_hist','MSE','target_sp_hist','mu_sp_hist','target_p_hist','mu_p_hist','state_dot_hist','LTI');
save('para_3rd.mat','para');