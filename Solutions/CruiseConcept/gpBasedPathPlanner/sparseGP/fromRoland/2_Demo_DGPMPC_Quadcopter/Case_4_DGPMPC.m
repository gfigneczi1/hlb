...
% axis([0 20 -3 3.5]);
 ...
 if flag_update == 1
     Smodel_x.postS = 1e-1*eye(Smodel_x.m);
     Smodel_y.postS = 1e-1*eye(Smodel_x.m);
     Smodel_z.postS = 1e-1*eye(Smodel_x.m);
 end
...
save('DGP_1st.mat','x','u','cost_trans','mu_p_hist','MSE','target_sp_hist','mu_sp_hist','target_p_hist','mu_p_hist','state_dot_hist','LTI');
save('para.mat','para');