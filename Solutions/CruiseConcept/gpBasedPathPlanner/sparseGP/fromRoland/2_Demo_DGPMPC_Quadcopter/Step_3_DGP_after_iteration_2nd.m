...
close all
load training_in_1.mat
load training_out_1.mat
load training_target_1.mat    
% load para.mat
test = 1;
...
training_in_p_new = training_in_p_new(100:end,:);
training_out_p_new = training_out_p_new(100:end,:);
...
for i = 1:N
   ...
   [phiz,~,~,~,~] = computeKminv(Smodel_z, training_in_1(i,:));
       ...
       Smodel_x = ROSV_GP_lambda(Smodel_x,err_x,phix);
       Smodel_y = ROSV_GP_lambda(Smodel_y,err_y,phiy);
       Smodel_z = ROSV_GP_lambda(Smodel_z,err_z,phiz);
...
save('training_in_2.mat','training_in_p');
save('training_out_2.mat','training_out_p');
save('training_target_2.mat','training_target_p');
