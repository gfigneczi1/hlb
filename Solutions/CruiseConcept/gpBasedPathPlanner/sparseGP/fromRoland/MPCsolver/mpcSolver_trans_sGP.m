function [u_i,f_value] = mpcSolver_trans_sGP(x0,t0)
...
% 
%     if t <= 10*dT
%           var_xkp1 = zeros(6);   % in the first several steps, the variance maybe too large. only use it into popagation until converged after 5 steps
%     else
%           var_xkp1 = A*var_xk*A' + dT.^2*blkdiag(zeros(3),var_d);
%     end
%         
