...
global mpcobj
      ...
      %  DGP prediction
          [mu_dx,var_dx] = DGP_varsgpPredict_x_2_mex(model_x,Smodel_x,mu_xu,var_xu);
          [mu_dy,var_dy] = DGP_varsgpPredict_y_2_mex(model_y,Smodel_y,mu_xu,var_xu);
          [mu_dz,var_dz] = DGP_varsgpPredict_z_2_mex(model_z,Smodel_z,mu_xu,var_xu);
