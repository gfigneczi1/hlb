function [u_i,f_value] = mpcSolver_trans_lGP(x0,t0)
...
%         Smodel_z = mpcobj.Smodel_z;
      ...
      % combine GP inputs
        ...
        % evaluate disturbance with mex!
          [mu_dx,var_dx] = varsgpPredict_MM_x_c_mex(model_x,mu_xu,var_xu);
          [mu_dy,var_dy] = varsgpPredict_MM_y_c_mex(model_y,mu_xu,var_xu);
          [mu_dz,var_dz] = varsgpPredict_MM_z_c_mex(model_z,mu_xu,var_xu);
