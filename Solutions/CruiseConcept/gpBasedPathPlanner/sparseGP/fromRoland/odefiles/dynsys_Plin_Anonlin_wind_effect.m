function state_dot = dynsys_Plin_Anonlin_wind_effect(t,x,u,LTI,para,i)
    ...
    state_dot = [dx_trans;
     ...
     %% add wind disturbances to nominal model 
      % wind-related parameters
         ...
         in_effect = indoor_effect_2D(xtrans(1:2));  % x,y
         state_dot = state_dot - [zeros(1,3),in_effect'/para.m, zeros(1,6)]';
