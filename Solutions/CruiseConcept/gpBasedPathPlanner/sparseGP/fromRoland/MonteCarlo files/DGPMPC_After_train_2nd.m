...
function res = DGPMPC_After_train_2nd()
...
res.x = x;
res.u = u;
res.cost_trans = cost_trans;
res.mu_p_hist = mu_p_hist;
res.MSE = MSE;
res.target_sp_hist = target_sp_hist;
res.mu_sp_hist = mu_sp_hist;
res.target_p_hist = target_p_hist;
res.mu_p_hist = mu_p_hist;
res.state_dot_hist = state_dot_hist;
res.para = para;
%%
